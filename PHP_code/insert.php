...
$sql="INSERT INTO test (Id_patient,Nivel_de_amputacion,Deambulacion_previa,Independiente_o_no,Vive_solo,Ascensor,Alteraciones_de_la_vision,
Deterioro_cognitivo,Estado_general_del_paciente,Grado_de_colaboracion,M_S_Deformidades,M_S_Rango_articular,M_S_Balance_muscular,M_S_Manos,
M_I_No_Funcionalidad,M_I_No_Presencia_de_flexos,M_I_No_Presencia_de_dolor_en_articulaciones_por_artrosis,M_I_No_Balance_muscular,M_I_No_Pulsos_arteriales_distales,
M_I_A_Nivel,M_I_A_Inspeccion,M_I_A_Conformacion_del_munon,M_I_A_Longitud_transfemoral,M_I_A_Longitud_Transtibial,M_I_A_Edema,
M_I_A_Presencia_espicula_osea,M_I_A_Rasgos_anadibles,M_I_A_Rango_articular_transfemoral,M_I_A_Rango_articular_transtibial,M_I_A_Balance_muscular_transfemoral,
M_I_A_Balance_muscular_transtibial,Miembro_fantasma,Valor_equilibrion_unipodal, Date) VALUES ('$Id_patient','$Nivel_de_amputacion','$Deambulacion_previa',
'$Independiente_o_no','$Vive_solo','$Ascensor','$Alteraciones_de_la_vision','$Deterioro_cognitivo','$Estado_general_del_paciente','$Grado_de_colaboracion',
'$M_S_Deformidades','$M_S_Rango_articular','$M_S_Balance_muscular','$M_S_Manos','$M_I_No_Funcionalidad','$M_I_No_Presencia_de_flexos','$M_I_No_Presencia_de_dolor_en_articulaciones_por_artrosis',
'$M_I_No_Balance_muscular','$M_I_No_Pulsos_arteriales_distales','$M_I_A_Nivel','$M_I_A_Inspeccion','$M_I_A_Conformacion_del_munon','$M_I_A_Longitud_transfemoral',
'$M_I_A_Longitud_Transtibial','$M_I_A_Edema','$M_I_A_Presencia_espicula_osea','$M_I_A_Rasgos_anadibles','$M_I_A_Rango_articular_transfemoral',
'$M_I_A_Rango_articular_transtibial','$M_I_A_Balance_muscular_transfemoral', '$M_I_A_Balance_muscular_transtibial','$Miembro_fantasma',
'$Valor_equilibrion_unipodal', '$Date')";
